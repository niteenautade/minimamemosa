...
>
> ⚠️ The demo app is **not** meant for daily use — its data gets wiped on every deployment. For personal use, self-host the app with a Docker volume (see [Quick Start](#quick-start)) so your data persists.
